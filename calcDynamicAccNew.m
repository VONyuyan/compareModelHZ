...
a = item(1)*1e-03; b = item(2)*1e-03; c = item(3)*1e-03; 
V1 = item(4); afix = item(5);
A = item(6)*1e-08; B = item(7)*1e-05; C = item(8)*1e-03; D = item(9)*1e-01; E = item(10);
V2 = item(11); afix2 = item(12);
